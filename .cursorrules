...
## Tests
Try to avoid shallow tests which are almost guarnteed to pass. Instead, try ones that challenge the componet you're testing.
If you need to delete a test, give the user a justification.
