...
These are used for game mechanics and do not require attribution, but we acknowledge their use.
...
Puzzle generation algorithms and game logic are inspired by:
- Classic puzzle game implementations
- Open-source puzzle solvers
- Academic papers on puzzle generation
- Community-contributed algorithms

## UI/UX Inspiration

The user interface design is inspired by:
- Modern puzzle game interfaces
- Material Design principles
- Various self-hosted application designs
