...
The following puzzle datasets are generated internally by the Enigma project:

#### Suko
- **Source**: Internally generated by Enigma project
- **Count**: 10,000 uniquely solvable puzzles
- **Format**: 3×3 grid with corner sum clues and color group constraints
- **Generation**: Puzzles are generated using constraint satisfaction and verified for unique solvability
- **Scripts**: `scripts/generate_suko_dataset.py`, `scripts/test_suko_uniqueness.py`
...
Pentomino puzzle solutions sourced from:

- **Repository**: [mlepage/pentomino-solver](https://github.com/mlepage/pentomino-solver)
- **License**: MIT License
- **Count**: 16,146 solutions
- **Format**: 8×8 board with 2×2 hole in center
- **Description**: Solutions for tiling an 8×8 board (with center 2×2 hole) using all 12 pentomino pieces
