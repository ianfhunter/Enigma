...
// ===========================================
// Connections - Puzzle Generation Tests
// ===========================================
describe('Connections - Puzzle Generation', () => {
  const GRID_SIZE = 4;
...
// ===========================================
// Connections - Category Matching Tests
// ===========================================
describe('Connections - Category Matching', () => {
  const mockPuzzle = {
    categories: [
...
// ===========================================
// Connections - Game State Tests
// ===========================================
describe('Connections - Game State', () => {
  const MAX_MISTAKES = 4;
...
// ===========================================
// Connections - Difficulty Colors Tests
// ===========================================
describe('Connections - Difficulty Colors', () => {
...
// ===========================================
// Connections - Shuffle Tests
// ===========================================
describe('Connections - Shuffle', () => {
