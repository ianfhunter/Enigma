...
export {
  GRID_SIZES,
  generatePuzzle,
  _isValidPlacement as isValidPlacement,
  findErrors,
  checkSolved,
};
...
export default function Futoshiki() {
  ...
  return (
    <div className={styles.container}>
      <GameHeader
        title="Futoshiki"
        instructions={`Fill the grid with numbers 1-${size}. Each row and column must have unique numbers. Respect the inequality signs between cells!`}
      />
