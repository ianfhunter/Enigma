...
1. Move in a direction and you'll slide until hitting something
...
**Source:** Generated ice sliding puzzles

## Tips & Strategy

- Plan your path considering where you'll stop
- Use walls strategically to control your position
- Some gems may require multiple moves to reach

## Issues & Bugs

🔍 [Search existing issues for "Inertia"](https://github.com/ianfhunter/Enigma/issues?q=is%3Aissue+Inertia)

📝 [Report a new bug](https://github.com/ianfhunter/Enigma/issues/new?labels=bug&title=%5BInertia%5D+)
