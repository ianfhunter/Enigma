...
Shade cells so circled numbers equal the sum of adjacent shaded group sizes.
...
**Source:** Generated sum-based shading puzzles

## Tips & Strategy

- A circle with 0 means no adjacent shaded cells
