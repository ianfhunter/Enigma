...
1. Domino-shaped spaces can be: +/-, -/+, or empty
...
**Source:** Generated magnet placement puzzles

## Tips & Strategy

- + and - alternate where magnets touch
- Empty spaces break the alternating pattern
- Row/column counts limit possibilities

## Issues & Bugs

🔍 [Search existing issues for "Magnets"](https://github.com/ianfhunter/Enigma/issues?q=is%3Aissue+Magnets)

📝 [Report a new bug](https://github.com/ianfhunter/Enigma/issues/new?labels=bug&title=%5BMagnets%5D+)
