...
import { DISK_COUNTS, DISK_COLORS } from './TowerOfHanoi.jsx';

describe('TowerOfHanoi - helpers', () => {
  it('exposes disk counts and colors', () => {
    expect(DISK_COUNTS).toContain(3);
    expect(DISK_COLORS.length).toBeGreaterThan(0);
  });
});
import { describe, it, expect } from 'vitest';
