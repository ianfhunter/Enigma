...
const WORDS = [
  'PROGRAMMING', 'JAVASCRIPT', 'ALGORITHM', 'DEVELOPER', 'COMPUTER',
  'SOFTWARE', 'KEYBOARD', 'DATABASE', 'FUNCTION', 'VARIABLE',
  'INTERFACE', 'FRAMEWORK', 'LIBRARY', 'COMPONENT', 'TERMINAL',
  'BEAUTIFUL', 'ADVENTURE', 'DISCOVERY', 'KNOWLEDGE', 'CHALLENGE'
];
