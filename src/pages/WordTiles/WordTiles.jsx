...
export default function WordTiles() {
  ...
  const handleSkip = () => {
    ...
    // Return tiles to hand and draw new ones
    handleClear();

    // Put current tiles back in bag and draw new ones
    const currentTiles = tiles.filter(t => t !== null);
    const newBag = [...bag, ...currentTiles];
    ...
    setBag(newBag);
    setTiles(newTiles);
    setMessage('Tiles swapped! -10 points');
