...
import styles from './Wordiply.module.css';
...
export default function Wordiply() {
  ...
  const [stats, setStats] = useState(() => {
    const saved = localStorage.getItem('wordiply-stats');
  ...
  const initGame = useCallback(() => {
    ...
    const seedNum = stringToSeed(`wordiply-${today}`);
  ...
  useEffect(() => {
    localStorage.setItem('wordiply-stats', JSON.stringify(stats));
  }, [stats]);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <h1 className={styles.title}>Wordiply</h1>
